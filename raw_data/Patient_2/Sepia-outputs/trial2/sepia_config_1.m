...
input = struct();
input(1).name = 'H:\My Drive\Maitrise\Project\Data\first qsm trial\Patient_2\Sepia-outputs\trial1\Sepia_fieldmap.nii.gz' ;
input(2).name = '' ;
...
output_basename = 'H:\My Drive\Maitrise\Project\Data\first qsm trial\Patient_2\Sepia-outputs\trial2\Sepia' ;
