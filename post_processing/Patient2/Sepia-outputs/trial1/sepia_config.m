...
input = struct();
input(1).name = 'H:\My Drive\Maitrise\Project\Data\first qsm trial\Patient_2\Phase_data.nii.gz' ;
...
output_basename = 'H:\My Drive\Maitrise\Project\Data\first qsm trial\Patient_2\Sepia-outputs\trial1\Sepia' ;
mask_filename = [''] ;
