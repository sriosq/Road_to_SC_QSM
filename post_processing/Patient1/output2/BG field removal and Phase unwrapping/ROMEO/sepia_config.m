...
output_basename = 'H:\My Drive\Maitrise\Project\Data\first qsm trial\Patient_1\output2\BG field removal\Sepia' ;
...
algorParam.unwrap.offsetCorrect = 'Bipolar (>= 3 echoes)' ;
